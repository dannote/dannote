...
**[OpenPencil](https://github.com/open-pencil/open-pencil)** — AI-native design editor. Open-source Figma alternative built on Skia/WebGPU. [Try it online](https://app.openpencil.dev/demo) · [Website](https://openpencil.dev)
...
**[just-bun](https://github.com/dannote/just-bun)** — Opinionated Bun + Elysia + Vue starter. Single binary, no Docker — just `just bun` and ship.
...
**[tongue](https://github.com/abiko-search/tongue)** — Natural language detector, port of Nakatani Shuyo's algorithm. [Hex](https://hex.pm/packages/tongue)

**[laughter](https://github.com/abiko-search/laughter)** — Streaming HTML parser built on Cloudflare's LOL HTML. [Hex](https://hex.pm/packages/laughter)
...
**[slovnet](https://github.com/natasha-ex/slovnet)** — Named entity recognition with CNN+CRF (PER, LOC, ORG).
